...
export type HMNCreateHugRequestInput = {
  ...
  hugRequest: HMNHugRequestInput;
};

export type HMNHugRequestInput = {
  id?: InputMaybe<Scalars['UUID']['input']>;
  message?: InputMaybe<Scalars['String']['input']>;
...
export type ResolversTypes = ResolversObject<{
  ...
  HMNHugRequestInput: HMNHugRequestInput;
  ...
  HMNMoodStreak: ResolverTypeWrapper<HMNMoodStreak>;
}>;
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  moodStreak?: Resolver<ResolversTypes['HMNMoodStreak'], ParentType, ContextType, RequireFields<QuerymoodStreakArgs, 'userId'>>;
...
export type HMNMoodStreakResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['HMNMoodStreak'] = ResolversParentTypes['HMNMoodStreak']> = ResolversObject<{
...
export type Resolvers<ContextType = MeshContext> = ResolversObject<{
  ...
  HMNMoodStreak?: HMNMoodStreakResolvers<ContextType>;
}>;
...
export const rawServeConfig: YamlConfig.Config['serve'] = {"browser":false,"playground":true,"cors":{"origin":"*","credentials":true},"port":4000} as any
...
const postGraphileApiHandler = new PostGraphileApiHandler({
              ...
              config: {"endpoint":"http://localhost:3003/postgraphile/graphql","batch":true,"operationHeaders":{"Authorization":"{context.headers.authorization}"},"schemaHeaders":{"Authorization":"{context.headers.authorization}"}},
              baseDir,
              cache,
              pubsub,
...
transforms[1] = new RootTransform_1({
            apiName: '',
            config: {"includeRootOperations":false,"value":"HMN","ignore":["User","Mood","Hug","HugRequest","Friendship"]},
            baseDir,
            cache,
            pubsub,
            importFn,
...
transforms[2] = new RootTransform_2({
            apiName: '',
            config: {"filters":["Query.!(_*|metadata|schema|clientInfo)","Mutation.!(_*|metadata|deleteNode|registerUser)"]},
            baseDir,
            cache,
            pubsub,
            importFn,
...
transforms[3] = new RootTransform_3({
            apiName: '',
            config: {"renames":[{"from":{"type":"Mood","field":"score"},"to":"intensity"},{"from":{"type":"Mood","field":"isPublic"},"to":"public"},{"from":{"type":"Hug","field":"isRead"},"to":"read"}]},
            baseDir,
            cache,
            pubsub,
            importFn,
...
const useLiveQuery = await import("@graphql-mesh/plugin-live-query").then(handleImport);
additionalEnvelopPlugins[0] = await useLiveQuery({
          ...({
  ...
  "localStorage": {
    "enabled": true
          ...
          logger: logger.child({ plugin: "liveQuery" }),
          cache,
          pubsub,
          baseDir,
          importFn,
...
export function createBuiltMeshHTTPHandler<TServerContext = {}>(): MeshHTTPHandler<TServerContext> {
  return createMeshHTTPHandler<TServerContext>({
    ...
    rawServeConfig: {"browser":false,"playground":true,"cors":{"origin":"*","credentials":true},"port":4000},
  })
}
