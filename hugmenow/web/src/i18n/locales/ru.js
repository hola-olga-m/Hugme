export default {
  ...
  // Theme
  theme: {
    settings: 'Настройки цветовой темы',
    howItWorks: 'Как это работает',
    colorPaletteDescription: 'Выбор успокаивающей цветовой палитры может создать более комфортную атмосферу. Цвета влияют на ваше настроение и эмоции. Выберите палитру, которая соответствует тому, как вы хотите себя чувствовать.',
    customizeTheme: 'Настроить тему',
    selectPalette: 'Выберите цветовую палитру',
    createCustom: 'Создать собственную палитру',
    customColors: 'Настройка цветов',
    primaryColor: 'Основной цвет',
    secondaryColor: 'Вторичный цвет',
    bgColor: 'Цвет фона',
    textColor: 'Цвет текста',
    resetDefault: 'Сбросить к настройкам по умолчанию',
    apply: 'Применить цвета',
    paletteApplied: 'Цветовая палитра успешно применена!',
    feelingPrompt: 'Как вы себя чувствуете сегодня?',
    calm: 'Спокойно',
    happy: 'Счастливо',
