...
`,He=()=>{const{t:e}=ge(),o=K(),{colorPalette:r,setTheme:s}=Q(),[i,n]=g.useState(!1),d=u=>{s(u),n(!0),setTimeout(()=>{n(!1)},3e3)};return t.jsxs(ze,{children:[t.jsxs(De,{children:[t.jsx(Re,{onClick:()=>o(-1),"aria-label":e("navigation.back"),children:t.jsx(Ie,{})}),t.jsx(Me,{children:e("theme.settings")})]}),t.jsxs(Le,{children:[t.jsx("div",{className:"info-icon",children:t.jsx(Oe,{})}),t.jsxs("div",{className:"info-content",children:[t.jsx("h4",{children:e("theme.howItWorks")}),t.jsx("p",{children:e("theme.colorPaletteDescription")})]})]}),t.jsx(Te,{onSave:d,initialPalette:r.id}),t.jsx(_e,{visible:i,children:e("theme.paletteApplied")})]})};export{He as default};
//# sourceMappingURL=ThemeSettings-c2730fb9.js.map
