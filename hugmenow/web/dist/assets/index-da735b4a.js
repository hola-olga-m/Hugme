import{F as I,d as n,j as t,r as h,a as k,G as C,b as z}from"./main-f2044e1d.js";import{g as O,a as v,b as j,H as f,c as $,d as G}from"./hugIcons-573ce93f.js";import{m as d}from"./motion-639036ff.js";var S={exports:{}},P="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",D=P,E=D;function w(){}function T(){}T.resetWarningCache=w;var N=function(){function e(r,p,a,x,u,g){if(g!==E){var l=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw l.name="Invariant Violation",l}}e.isRequired=e;function i(){return e}var s={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:i,element:e,elementType:e,instanceOf:i,node:e,objectOf:i,oneOf:i,oneOfType:i,shape:i,exact:i,checkPropTypes:T,resetWarningCache:w};return s.PropTypes=s,s};S.exports=N();var R=S.exports;const o=I(R),_=n(d.div)`
  display: inline-flex;
